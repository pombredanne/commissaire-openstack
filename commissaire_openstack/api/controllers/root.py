...
from commissaire_openstack.api.controllers import v1
...
class Root(base.APIBase):
    ...
    def convert():
        root = Root()
        root.name = "OpenStack Commissaire_Openstack API"
        root.description = ("Commissaire_Openstack is an OpenStack project which aims to "
...
class RootController(rest.RestController):
    ...
    def _route(self, args):
        ...
        It redirects the request to the default version of the commissaire_openstack API
