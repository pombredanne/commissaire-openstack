...
from commissaire_openstack.conf import opts
...
class ConfTestCase(base.TestCase):
    ...
    def test_import_mods_no_func(self):
        ...
        with mock.patch('importlib.import_module') as mock_import:
            ...
            mock_import.assert_called_once_with('commissaire_openstack.conf.foo')
    ...
    def test_import_mods_valid_func(self):
        ...
        with mock.patch('importlib.import_module') as mock_import:
            ...
            mock_import.assert_has_calls([mock.call('commissaire_openstack.conf.foo'),
                                          mock.call('commissaire_openstack.conf.bar')])
