...
from commissaire_openstack.common.utils import check_container_id
from commissaire_openstack.common.utils import translate_exception
from commissaire_openstack.tests import base


class TestUtils(base.BaseTestCase):
    """Test cases for commissaire_openstack.common.utils"""
    ...
    def test_translate_exception(self):
        ...
        self.assertRaises(exception.Commissaire_OpenstackException, foo,
                          self, mock.MagicMock())
