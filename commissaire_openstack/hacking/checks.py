...
Guidelines for writing new hacking checks
 ...
 - Use only for Commissaire_Openstack specific tests. OpenStack general tests
 ...
 - Add test cases for each new rule to commissaire_openstack/tests/unit/test_hacking.py
